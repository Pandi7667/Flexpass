...
function AboutUs() {
  return (
    <>
          <div className='ptop_innerpage_bottom ptop_bottom about_flex pb-lg-5 pb-sm-4 pb-3'>
              <div className='container'>
                  <div className='row'>
                      {/* <div className='col-lg-6 col-sm-6 col-12' data-aos="fade-up" data-aos-duration="3000"> */}
                                  <div className='col-lg-6 col-sm-6 col-12 d-flex flex-column justify-content-center align-items-start' data-aos="fade-up" data-aos-duration="3000">
                      ...
                      <div className='col-lg-6 col-sm-6 col-12' data-aos="fade-up" data-aos-duration="3000">
                          <Image alt='About FLEXPASS ' src={assets.aboutBanner04} className='img-fluid banner_bx' />
                      </div>
                  </div>
              </div>
          </div>
          <div className='ptop_bottom flex_founded ' style={{ backgroundImage: `url(${aboutBanner.src})`, backgroundRepeat: 'no-repeat', backgroundPosition: 'center center', backgroundAttachment: 'scroll', backgroundSize: 'cover' }}>
              <div className='container'>
                  <div className='row'>
          ...
          <div className='ptop_innerpage_bottom ptop_bottom about_flex pb-lg-5 pb-sm-4 pb-3'>
              <div className='container'>
                  <div className='row'>
                      {/* <div className='col-lg-6 col-sm-6 col-12' data-aos="fade-up" data-aos-duration="3000"> */}
                      <div className='col-lg-8 col-sm-6 col-12 d-flex flex-column justify-content-center align-items-start' data-aos="fade-up" data-aos-duration="3000">
                          <h4>Magnifico Magsayo - FlexPass Ambassador</h4>
                          <p>Mark “Magnifico” Magsayo is the reigning WBC Super-Featherweight World Champion and WBC`s No. 1 contender in the junior lightweight division. He is celebrated for his explosive combinations, lightning-fast footwork, and relentless conditioning—qualities that embody the discipline and drive of elite athletes. His journey from the gyms of Bohol, Philippines, to the top of professional boxing is a testament to his focus, resilience, and an unshakable work ethic. These same qualities make us proud to introduce him as a FlexPass ambassador—as the app`s mission of providing diverse workouts and training styles aligns with Mark`s own adaptable, well-rounded regimen that blends strength, endurance, agility, and recovery. Just as he never settles for “good enough” in the ring, we at FlexPass inspire our members to break limits, push harder, and discover your peak potential.</p>
                      </div>
                      <div className='col-lg-4 col-sm-6 col-12' data-aos="fade-up" data-aos-duration="3000">
                          <Image alt='About FLEXPASS ' src={assets.FPAmbassador_MMM} className='img-fluid banner_bx' />
                      </div>
                  </div>
              </div>
          </div>
          <div className='flexMakes' style={{ backgroundImage: `url(${aboutBanner02.src})`, backgroundRepeat: 'no-repeat', backgroundPosition: 'center top', backgroundAttachment: 'fixed', backgroundSize: 'cover', minHeight: '500px', padding: '50px 0px' }}>
              <div className='container'>
                  <div className='row'>
